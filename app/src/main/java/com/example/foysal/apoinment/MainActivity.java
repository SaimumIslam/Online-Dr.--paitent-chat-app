...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Type = SharedPreferenceHelper.getInstance(this).getUserInfo().type;
        ...
        if(toolbar != null) {
            ...
            getSupportActionBar().setTitle("Hypertension");
        }
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        {
            adapter.addFrag(new RequirementFragment(), STR_GROUP_FRAGMENT);
            adapter.addFrag(new FriendsFragment(), STR_FRIEND_FRAGMENT);
            adapter.addFrag(new UserProfileFragment(), STR_INFO_FRAGMENT);
        ...
        viewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                ...
                } else if (adapter.getItem(position) instanceof RequirementFragment) {
...
//    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.about) {
            Toast.makeText(this, "Hypertension version 1.0", Toast.LENGTH_LONG).show();
            return true;
        }
