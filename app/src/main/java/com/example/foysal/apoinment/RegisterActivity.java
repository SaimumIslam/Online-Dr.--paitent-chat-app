...
public class RegisterActivity extends AppCompatActivity {
    ...
    private EditText FName, LName, Mname,Address, Citygenship, Weight,Height,Mobile;
    ...
    private String lname="",fName,mName,sex="",address,citygen,date,age="",weight="",height="",Type,number;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Mname=(EditText)findViewById(R.id.midName);
